...
export const data = <Folder extends keyof typeof datas, Key extends keyof typeof datas[Folder]>(folder: Folder, key: Key): typeof datas[Folder][Key] => {
...
export const dbBool = (x: number | string | boolean) => typeof x === 'number' ? (x === 1) : typeof x === 'string' ? (x === '1') : (x ? '1' : '0')